...
vim.keymap.set("n", "J", "mzJ`z",
  { desc = "Prime: takes the line below and appends it to your current line with a space" })
...
vim.keymap.set("x", "<leader>p", [["_dP]],
  { desc = 'Prime: delete the highlighted word and then paste over it keeping the current paste buffer' })
